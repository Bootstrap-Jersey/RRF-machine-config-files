...
M291 P"Please wait while the nozzle is being heated up" R"Loading ePA-CF" T5 	; Display message

G10 S255 										; Set current tool temperature to 255C
M116 P{state.currentTool}						; Wait for the temperatures to be reached
M291 P"Feeding filament..." R"Loading ePA-CF" T5 	; Display new message
