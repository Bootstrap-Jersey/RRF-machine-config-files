; Configuration file for Duet 3 running RRF3 on E3D Tool Changer
; executed by the firmware on start-up

; General preferences
M111 S0 						; Debugging off
M929 S3                         ; Set logging on
...
;M552 P0.0.0.0 S1			    ; Enable Networking
...
M569 P1.0 S0 					; 3HC Drive 0 WIPER
; M569 P22.0 S0 D2				; Drive 22.0 (E2) spreadCycle mode
; M569 P23.0 S0 D2 				; Drive 23.0 (E3) spreadCycle mode

M584 X2 Y1 Z0 C5 U1.0			; Axis to driver mapping
M584 E3:4:22.0:23.0				; set extruder drivers

M208 X-185:178.5 Y-149:49 Z0:300 C0:500 U0:100			; Set axis maxima & minima
M92 X100 Y100 Z1600 C200 E797:797:409:409 U400			; Set steps per mm assuming x16 microstepping
...
M566 X400 Y400 Z8 C2 U400 E1000:1000:1000:1000			; Set maximum instantaneous speed changes (mm/min)
M203 X35000 Y35000 Z1200 C10000 U10000 E5000:5000:5000:5000	; Set maximum speeds (mm/min)
M201 X6000 Y6000 Z400 C500 U6000 E2500:2500:2500:2500		; Set accelerations (mm/s^2)
M906 X2000 Y2000 Z1330 C500 U1500 E1400:1400:1000:1000 I30	; Set motor currents (mA) and motor idle factor in percent
...
M574 U2 S1 P"1.io0.in"                  ; Set Wiper endstop switch
...
; Bed heater
M308 S0 P"temp0" Y"thermistor" T100000 B4138 C0 A"Bed"	; Set thermistor 
...
; Tool 0 heater
M308 S1 P"temp1" Y"pt1000" A"T0" 	    ; Set pt1000
M950 H1 C"out1" T1						; Extruder 0 heater
M307 H1 R1.269 C220.6 D7.67 S1.00 V23.9 ; Heater 1 tuning results
M143 H1 S300 							; Set temperature limit for heater 1 to 300C

; Tool 1 heater
M308 S2 P"temp2" Y"pt1000" A"T1"        ; Set pt1000
M950 H2 C"out2" T2						; Extruder 1 heater
M307 H2 R1.486 C248.9 D5.57 S1.00 V23.9 ; Heater 2 tuning results
M143 H2 S300 							; Set temperature limit for heater 2 to 300C

; Chamber heater
M308 S3 P"temp3" Y"thermistor" T100000 B4267 C7.060000e-8 A"Chamber"	; Set thermistor 
M950 H3 C"out3" T3						; Bed heater
M141 H3									; Chamber heater is heater 3
M143 H3 S50 							; Set temperature limit for heater 0 to 50C
;M307 H3 A590.6 C474.5 D4.4 				; Heater 3 tuning results

; Tool 2 heater
; M308 S3 P"22.temp0" Y"pt1000" 
; M950 H3 C"22.out0" T3
; M143 H3 S300 							; Set temperature limit for heater 3 to 300C

; Tool 3 heater
; M308 S4 P"23.temp0" Y"pt1000" 
...
M200 D1.75:1.75:1.75:1.75               ; Set filament diameter for all tools
...
; M950 J3 C"23.!^io0.in"					; GpIn 2 = tool 3 dock switch
